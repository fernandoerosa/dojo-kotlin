class ChangeHelper() {
    ...
    fun calculateChange(totalValue: Double, paidValue: Double): MutableMap<Double, Int> {

        val change = paidValue - totalValue
        
        if (change < 0) {
            throw Exception("The paid amount is insufficient to cover the total due.")
        }
